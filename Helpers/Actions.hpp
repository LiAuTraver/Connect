...
_NODISCARD CONNECT_INLINE CONNECT_CONSTEXPR IODeviceBase::OpenModeFlag operator|(IODeviceBase::OpenModeFlag lhs,
...
_NODISCARD CONNECT_INLINE CONNECT_CONSTEXPR IODeviceBase::OpenModeFlag operator~(IODeviceBase::OpenModeFlag flag) {
...
_NODISCARD CONNECT_INLINE CONNECT_CONSTEXPR IODeviceBase::OpenModeFlag& operator^=(IODeviceBase::OpenModeFlag& lhs,
																				   IODeviceBase::OpenModeFlag rhs) {
	return lhs = static_cast<IODeviceBase::OpenModeFlag>(static_cast<int>(lhs) ^ static_cast<int>(rhs));
}
_NODISCARD CONNECT_INLINE CONNECT_CONSTEXPR IODeviceBase::OpenModeFlag operator^(IODeviceBase::OpenModeFlag lhs,
																				 IODeviceBase::OpenModeFlag rhs) {
	return static_cast<IODeviceBase::OpenModeFlag>(static_cast<int>(lhs) ^ static_cast<int>(rhs));
